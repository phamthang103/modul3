...
public class UserDao implements IUserDao{
    ...
    private static final String SELECT_ALL_USERS_COUNTRY = "select * from users where country like ?";
    ...
    public List<User> selectAllUser(String country) {
        ...
        try (Connection connection = getConnection();
             ...
             // Step 2:Create a statement using connection object
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_USERS_COUNTRY)) {
            System.out.println(preparedStatement);
